...
public class PopupCategoryView 	extends LinearLayout {
		PopupWindow pop;
		Context context;
		...
		public PopupCategoryView(Context context, PopupWindow pop,OnListItemClickListener itemClickListener) {
		...
		public PopupCategoryView(Context context, AttributeSet attrs) {
			// TODO Auto-generated constructor stub
			super(context, attrs);
		}

		public PopupCategoryView(Context context, AttributeSet attrs, int defStyle) {
			super(context, attrs);
			// TODO Auto-generated constructor stub
		}
