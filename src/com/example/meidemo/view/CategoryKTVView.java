...
public class CategoryKTVView extends LinearLayout implements ICategory {
	public static final String TAG = "CategoryKTVView";
	/** 分类*/
	String category= "";
	/**该分类编号*/
	String index;
	...
	public CategoryKTVView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public CategoryKTVView(Context context,String category,String index) {
		super(context);
	...
	private void initView() {
		View view = inflate(context, R.layout.category_ktv, this);
